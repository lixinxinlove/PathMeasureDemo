package com.love.lixinxin.pathmeasuredemo.http.impl;


import android.util.Log;

import com.love.lixinxin.pathmeasuredemo.http.IHttpClient;
import com.love.lixinxin.pathmeasuredemo.http.IRequest;
import com.love.lixinxin.pathmeasuredemo.http.IResponse;
...
public class OkHttpClientImpl implements IHttpClient {
    ...
    private IResponse execute(Request request) {
        ...
        try {
            ...
            Log.e("OkHttpClientImpl", String.format("Received response body: %s ", body));
        } catch (IOException e) {
            e.printStackTrace();
